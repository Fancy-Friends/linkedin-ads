 ...
 */
/**
 * Every LinkedIn Ads node executor — the PHP twin of
 * `LINKEDIN_ADS_RUNNABLE_KINDS` in @particle-academy/linkedin-ads-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `LinkedinAdsFlow::register($kinds, $executors)` — one call, no directory
 * scan.
 ...
 */
final class LinkedinAdsFlow
{
    /** @var list<class-string> */
    public const EXECUTORS = [
        CampaignExecutor::class,
    ];
