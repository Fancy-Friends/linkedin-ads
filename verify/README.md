...
| Registry | Package |
|---|---|
| npm | `@particle-academy/linkedin-ads-js` (+ `@particle-academy/linkedin-ads-ui`, resolved transitively) |
...
npm install @particle-academy/linkedin-ads-js @particle-academy/fancy-flow
